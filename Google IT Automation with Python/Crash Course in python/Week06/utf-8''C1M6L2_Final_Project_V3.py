...
def calculate_frequencies(file_contents):
    ...
    for sign_p in punctuations:
        while  sign_p in file_contents:
            file_contents=file_contents[:file_contents.index(sign_p)-1]+file_contents[file_contents.index(sign_p)+1:]
